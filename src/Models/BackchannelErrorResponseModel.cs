...
namespace Talegen.Backchannel.Models
{
    ...
    /// </summary>
    public class BackchannelErrorResponseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackchannelErrorResponseModel" /> class.
        /// </summary>
        public BackchannelErrorResponseModel()
        {
            this.Messages = new List<BackchannelErrorModel>();
        ...
        /// </summary>
        public List<BackchannelErrorModel> Messages { get; }
